...
<form method="post" action="db/DB_admin_update.php" enctype="multipart/form-data">
    <div class="row gtr-uniform">
        <div class="col-12 col-12-xsmall">
            ...
            <input type="text" name="name" id="demo-username"  placeholder="Name of donor recipient " value="<?=((isset($rowOne["id"]) && $rowOne["id"]) ? $rowOne["name"] : "" )?>" required />
        </div>
    ...
    <table id="datatable" class="table table-striped" style="width:100%;font-size: 13px;">
        ...
        <?php  while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td class="text-center">
                    <a href="db/DB_admin_update.php?delete_recipient_types=&id=<?=$row["id"]?>"><i class="fa-solid fa fa-trash fa-xl text-danger" onclick='return confirmDelete();'></i></a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
